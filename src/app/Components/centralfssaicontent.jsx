          ...
          <div className="w-full lg:w-3/4">
            ...
            <div className=" p-8 md:p-6">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-8">
                ...
                having high turnover must obtain an FSSAI Central License.
              </p>
    ...
    <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6 mt-6">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 text-center shadow-md hover:shadow-xl hover:-translate-y-1 transition duration-300">
        ...
        <p className="text-gray-600 text-sm">
          Food businesses with turnover exceeding ₹20 crores.
        </p>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 text-center shadow-md hover:shadow-xl hover:-translate-y-1 transition duration-300">
        ...
        <div className="w-14 h-14 mx-auto flex items-center justify-center rounded-full bg-orange-200 mb-4">
          <FaHotel className="text-orange-600 text-2xl" />
        </div>

        <h3 className="font-semibold text-16px mb-2 text-gray-800">
          Large Manufacturers & Hotels
        </h3>

        <p className="text-gray-600 text-sm">
          Large manufacturers and 5-star hotels.
        </p>
                ...
                {
  title: "Procedures for Obtaining Central License",
  content: (
    <div className="relative max-w-5xl mx-auto py-14">
      ...
      <div className="ml-44 space-y-12">
        ...
        {[
          ...
          "Application scrutiny by department",
          "Inspection of premises (if required)",
          "Download license certificate after approval",
        ].map((step, index) => {
          ...
          return (
            <div key={index} className="flex items-center gap-6">
              ...
              >
                ...
                {
                  title: "Advantages of Central License",
                  content: (
                    <div className="mt-12">
                      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        {[
                          {
                            title: "Enhances Business Credibility",
                            description:
                              "Improves brand reputation and increases customer confidence.",
                            color: "green",
                          ...
                          },
                          {
                            ...
                            description:
                              "Ensures the food business complies with FSSAI regulations.",
                            color: "orange",
                          ...
                          },
                          {
                            ...
                            description:
                              "Mandatory for selling food products on e-commerce platforms.",
                            color: "green",
                          ...
                          },
                          {
                            ...
                            description:
                              "Demonstrates commitment to food safety and hygiene standards.",
                            color: "orange",
    ...
    <div className="mt-10 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 gap-4 w-full md:hidden px-4">
        ...
        {[
          ...
          "Authority letter with responsible person details",
...
{
  title: "Timeline for FSSAI Central License",
  content: (
    <div className="mt-6">
...

                {
                  ...
                  content: (
                    <ul className="list-disc pl-6 space-y-3">
                      <li>Annual return must be filed before 31st May every year.</li>
                      <li>Separate return is required for each license category.</li>
                      <li>Penalty of ₹100 per day for delayed filing.</li>
                    </ul>
                  ),
                },
              ].map((section, index) => (
